    ...
    def __init__(self, calcul):
        for n in calcul:
            assert n == "1" or n == "2" or n == "3" or n == "4" or n == "5" or n == "6" or n == "7" or n == "8" \
                   or n == "9" or n == "0" or n == "+" or n == "-" or n == "*" or n == "/", "Le calcul ne contient " \
                                                                                            "pas que des chiffres et " \
                                                                                            "des opérateurs "
        assert self.est_un_chiffre(calcul[-1]), "Le  dernier nombre est un opérateur"
        self.chiffre = []
        self.operator = []
        self.calcul = calcul
